...
public class winplane extends JPanel implements ActionListener, KeyListener{
   ...
   i2[0]=new ImageIcon("C:\\Users\\Admin\\Desktop\\starting menu\\project v-1\\src\\snakeimage.png");
   ...
   if(up)
       i1=new ImageIcon("C:\\Users\\Admin\\Desktop\\starting menu\\project v-1\\src\\pu.png");
   else if(down)
       i1=new ImageIcon("C:\\Users\\Admin\\Desktop\\starting menu\\project v-1\\src\\pd.png");
   else if(right)
       i1=new ImageIcon("C:\\Users\\Admin\\Desktop\\starting menu\\project v-1\\src\\pr.png");
    else 
            i1=new ImageIcon("C:\\Users\\Admin\\Desktop\\starting menu\\project v-1\\src\\pl.png");
   //if(up) 
