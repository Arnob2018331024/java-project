...
public class winplane extends JPanel implements ActionListener, KeyListener{
   ...
   i2[0]=new ImageIcon("build\\classes\\almost\\snakeimage.png");
   ...
   if(up)
       i1=new ImageIcon("build\\classes\\almost\\pu.png");
   else if(down)
       i1=new ImageIcon("build\\classes\\almost\\pd.png");
   else if(right)
       i1=new ImageIcon("build\\classes\\almost\\pr.png");
    else 
            i1=new ImageIcon("build\\classes\\almost\\pl.png");
   //if(up) 
